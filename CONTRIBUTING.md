...
This repository is the Ruby daemon client for Kryptic (`kryptic-daemon-client`).
...
the Kryptic Release Bot, publishes to RubyGems, tags `vX.Y.Z`, and opens a
